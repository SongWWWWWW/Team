...
class PromptTemplate:
    def __init__(self) -> None:
        ...
        任务目标：
        1. 理解问题: 明确问题的关键内容。
        2. 提取信息: 根据问题从给定的文本中提取相关信息。
        3. 简洁回答: 根据提取的信息，生成简洁、精确、具体的答案。

        要求：
        1. 仅使用提供的信息: 不引用、依赖外部信息源。
        2. 精确匹配: 充分理解问题，准确抓住问题的核心和关键词，生成与问题和信息匹配的关键词和答案。
        3. 简洁明了: 答案要简洁明了，不包含多余的内容。
        4. 优先级分析: 对传入的文本进行优先级分析，前几段文本相关性最高，应重点分析，后面几段文本优先级稍低，但仍需考虑。
        5. 避免冗余: 回答中避免提及无法提供更详尽答案的内容，只回答问题的核心部分，避免使用诸如“在提供的上下文中”、“没有直接描述”、“但是可以根据xx上下文”等冗余表达。
